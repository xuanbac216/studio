...
<div class="<?php if (get_field('soundtheme_musicshow_info') == "true"): ?> col-md-8 <?php else : ?> col-md-12 <?php endif; ?>	">
	...
	<div class="soundtheme-single-titles">
		...
		<?php else: ?>
			<h1><?php _e( 'Gallery', 'sound-theme' ); ?></h1>
		<?php endif; ?>
	</div>

	<div class="soundtheme-single-track soundtheme-gallery-space">
		<div class="soundtheme-gallery-row">
			<?php $images = get_field('soundtheme_gallery_posts'); if( $images ): ?>
			    <?php foreach( $images as $image ): ?>
				    <div class="col-xs-6 col-sm-3">

				    	<div class="soundtheme-single-gallery">
						    <a href="<?php echo esc_url($image['sizes']['soundtheme-thumb-normal']); ?>">
						    	<img src="<?php echo esc_url($image['sizes']['soundtheme-thumb-medium']); ?>" alt="" />
						    	<div class="soundtheme-gallery-hover"><i class="fa fa-search"></i></div>
						    </a>
						</div>
