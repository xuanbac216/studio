<!-- SOUND THEME / TRACK LIST -->
<div class="<?php if (get_field('soundtheme_musicshow_info') == "true"): ?> col-md-8 <?php else : ?> col-md-12 <?php endif; ?>	">
	<?php $soundtheme_count = get_field('soundtheme_tracklist');
			$soundtheme_showcount = count($soundtheme_count); ?>
	...
	<div class="soundtheme-single-titles">
		<?php if ($soundtheme_tracklisttitle) : ?>
			<h1><?php echo esc_attr($soundtheme_tracklisttitle); ?> <?php if (esc_attr( get_field('soundtheme_select_player') == "sound") ): ?><span class="soundtheme-single-count">(<?php echo esc_attr( $soundtheme_showcount); ?>)</span><?php endif; ?></h1>
		<?php else: ?>
			<h1><?php _e( 'Tracklist', 'sound-theme' ); ?> <?php if (esc_attr( get_field('soundtheme_select_player') == "sound") ): ?><span class="soundtheme-single-count">(<?php echo esc_attr( $soundtheme_showcount); ?>)</span><?php endif; ?></h1>
		<?php endif; ?>
	</div>
