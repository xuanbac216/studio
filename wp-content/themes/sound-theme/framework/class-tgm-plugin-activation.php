	...
	class TGM_Plugin_Activation {
		...
		public function filter_plugin_action_links_update( $actions ) {
			$actions['update'] = sprintf(
				...
				esc_html( 'Update Required', 'tgmpa' )
			);
					...
					public function add_strings() {
						if ( 'update' === $this->options['install_type'] ) {
							...
							if ( $this->tgmpa->is_automatic ) {
								...
								$this->upgrader->strings['skin_update_successful']    = __( '%1$s installed and activated successfully.', 'tgmpa' ) . ' <a href="#" class="hide-if-no-js" onclick="%2$s"><span>' . esc_html( 'Show Details', 'tgmpa' ) . '</span><span class="hidden">' . esc_html( 'Hide Details', 'tgmpa' ) . '</span>.</a>';
