...
var color_option = [
{name: "header-background-color", selector: ".gdlr-header-overlay{ background-color: #gdlr#; }"},
...
{name: "container-backgrond", selector: ".body-overlay{ background-color: #gdlr#; }"},
{name: "page-title-color", selector: ".gdlr-page-title{ color: #gdlr#; }"},
{name: "page-caption-color", selector: ".gdlr-page-caption{ color: #gdlr#; }"},
{name: "page-title-icon-color", selector: ".gdlr-page-title-wrapper .gdlr-page-header-icon { border-color: #gdlr#; color: #gdlr#; }"},
{name: "heading-color", selector: "h1, h2, h3, h4, h5, h6, .gdlr-title, .gdlr-title a{ color: #gdlr#; }"},
{name: "item-title-color", selector: ".gdlr-item-title-wrapper .gdlr-item-title, .gdlr-item-title-wrapper .gdlr-separator{ color: #gdlr#; border-color: #gdlr#; }"},
...
{name: "twitter-widget-icon", selector: "ul.gdlr-twitter-widget li:before{ color: #gdlr#; }"},
...
{name: "blog-date-text-color", selector: ".blog-date-wrapper{ color: #gdlr#; }"},
{name: "blog-date-bottom-border", selector: ".blog-date-wrapper, .blog-date-wrapper *{ border-bottom-color: #gdlr#; }"},
{name: "blog-info-color", selector: ".blog-info, .blog-info a, .comment-time, .comment-time a{ color: #gdlr#; }"},
{name: "blog-grid-content-background", selector: ".gdlr-blog-grid .gdlr-standard-style{ background-color: #gdlr#; }"},
...
{name: "modern-portfolio-title-background", selector: ".gdlr-modern-portfolio .portfolio-content-wrapper{ background-color: #gdlr#; }"},
...
{name: "single-album-playlist-background", selector: ".gdlr-album-song-list li{ background-color: #gdlr#; }"},
{name: "album-item-title-background", selector: ".gdlr-album-item .gdlr-album-content{ background-color: #gdlr#; }"},
{name: "album-item-title-background-hover", selector: ".gdlr-album-item .gdlr-album-content:hover{ background-color: #gdlr#; }"},
{name: "album-item-title-text", selector: ".gdlr-album-item .gdlr-album-content, .gdlr-album-item .gdlr-album-content a{ color: #gdlr#; }"},
{name: "player-list-background", selector: ".gdlr-top-player{ background: #gdlr#; }"},
{name: "player-list-song-title", selector: ".gdlr-top-player .gdlr-top-player-title{ color: #gdlr#; }"},
{name: "player-list-controller-background", selector: ".gdlr-top-player .mejs-container .mejs-controls{ background: #gdlr#; }"},
{name: "player-list-song-background", selector: ".gdlr-player-item .gdlr-player-list li{ background: #gdlr#; }"},
{name: "player-list-song-top-border", selector: ".gdlr-player-item .gdlr-player-list li, .gdlr-top-player .mejs-container .mejs-controls{ border-top-color: #gdlr#; } .gdlr-top-player .mejs-controls .mejs-time-rail{ border-left-color: #gdlr#; }"},
{name: "player-list-song-bottom-border", selector: ".gdlr-player-item .gdlr-player-list li, .gdlr-top-player .mejs-container .mejs-controls{ border-bottom-color: #gdlr#; } .gdlr-top-player .mejs-button.mejs-playpause-button{ border-right-color: #gdlr#; }"},
{name: "player-time-rail", selector: ".gdlr-top-player .mejs-controls .mejs-time-rail .mejs-time-total, .gdlr-float-player .mejs-controls .mejs-time-rail .mejs-time-total, .gdlr-float-player .mejs-controls .mejs-horizontal-volume-slider .mejs-horizontal-volume-total{ background: #gdlr#; }"},
{name: "player-time-loaded", selector: ".gdlr-top-player .mejs-controls .mejs-time-rail .mejs-time-loaded, .gdlr-top-player .mejs-controls .mejs-horizontal-volume-slider .mejs-horizontal-volume-total, .gdlr-float-player .mejs-controls .mejs-time-rail .mejs-time-loaded{ background: #gdlr#; }"},
...
{name: "single-event-info-head", selector: ".event-status-wrapper, .gdlr-single-event .gdlr-event-info .gdlr-head{ color: #gdlr#; }"},
{name: "single-event-title", selector: ".gdlr-single-event .gdlr-event-title, .event-status-wrapper .sold-out{ color: #gdlr#; }"},
{name: "single-event-location", selector: ".gdlr-single-event .gdlr-event-location{ color: #gdlr#; }"},
{name: "widget-event-title", selector: ".gdlr-widget-event .event-title a{ color: #gdlr#; }"},
{name: "widget-event-date", selector: ".gdlr-widget-event .event-date-wrapper{ color: #gdlr#; }"},
{name: "event-list-date-color", selector: ".gdlr-list-event .event-date-wrapper{ color: #gdlr#; }"},
{name: "event-list-title-color", selector: ".gdlr-list-event .event-location a, .gdlr-list-event .event-title a{ color: #gdlr#; }"},
...
{name: "slider-outer-navigation-border", selector: ".nav-container.style-1 .flex-direction-nav a{ border-color: #gdlr#; }"},
{name: "slider-outer-navigation-icon", selector: ".nav-container.style-1 .flex-direction-nav i{ color: #gdlr#; }"},
