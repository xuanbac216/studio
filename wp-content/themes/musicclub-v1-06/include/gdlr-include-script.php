	...
	if( !function_exists('gdlr_regiser_use_script') ){
		function gdlr_regiser_use_script($array){	
			...
			if( is_search() || is_archive() || 
				...
				( is_page() && gdlr_search_page_builder($all_page_builder, 'item', 'content-slider') ) ||
				( is_page() && gdlr_search_page_builder($all_page_builder, 'item', 'album', array('album-style', 'carousel')) ) ||
