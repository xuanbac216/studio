...
WpLattePostEntity
extends
WpLatteBaseEntity{protected$id;protected$type;protected$postId;protected$parentId;protected$menuOrder=0;protected$isCpt=false;protected$author;protected$slug;protected$rawExcerpt;protected$rawDate;function
__construct($post){$this->id=(int)$post->ID;$this->postId=$this->id;$this->type=$post->post_type;$this->slug=$post->post_name;$this->parentId=isset($post->post_parent)?(int)$post->post_parent:0;$this->menuOrder=isset($post->menu_order)?(int)$post->menu_order:0;$this->isCpt=WpLatteUtils::isCpt($post->post_type);$this->rawExcerpt=$post->post_excerpt;$this->rawDate=$post->post_date;$this->author=WpLatte::createEntity('PostAuthor',$post->post_author);}function
