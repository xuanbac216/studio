				...
				array(
					...
					'page-option' => array(
						...
						'options' => array(
							...
							'header-icon' => array(
								'title' => __('Header Icon' , 'gdlr_translate'),
								'type' => 'text'
							),						
			...
			$page_builder['content-item']['options']['portfolio'] = array(
				...
				'options'=>array(		
					...
					'portfolio-style'=> array(
						...
						'type'=> 'combobox',
						'options'=> array(
							'classic' => __('Portfolio Classic', 'gdlr-portfolio'),
							'classic-no-space' => __('Portfolio Classic Without Space', 'gdlr-portfolio'),
							'modern' => __('Portfolio Modern', 'gdlr-portfolio'),
							'modern-no-space' => __('Portfolio Modern Without Space', 'gdlr-portfolio')
						),
					),	
					'portfolio-info'=> array(
						'title'=> __('Portfolio Info' ,'gdlr-portfolio'),
						'type'=> 'combobox',
						'options'=> array(
							'tag'=> __('Tags', 'gdlr-portfolio'),
							'date'=> __('Date', 'gdlr-portfolio'),
							'none'=> __('None', 'gdlr-portfolio')
						),
						'wrapper-class'=> 'classic-wrapper classic-no-space-wrapper portfolio-style-wrapper'
					),
					'num-fetch'=> array(
					...
					'portfolio-layout'=> array(
						...
						'options'=> array(
							...
							'carousel' => __('Carousel', 'gdlr-portfolio'),
						),
					...
					'portfolio-filter'=> array(
						...
						'type'=> 'checkbox',
						'default'=> 'disable',
						'wrapper-class'=> 'portfolio-layout-wrapper fitRows-wrapper masonry-wrapper',
